...
call dein#add('junegunn/limelight.vim')                               " Distraction free helper
call dein#add('plasticboy/vim-markdown')                              " Markdown settings
call dein#add('roman/golden-ratio')                                   " Auto resize window based golden ratio
...
"""" Manipulate code
call dein#add('jamessan/vim-gnupg')                                   " GnuPG extensions
...
call dein#add('lervag/vimtex', {'on_ft': ['plaintex', 'tex']})        " Latex
...
call dein#add('cloudhead/neovim-fuzzy')                               " Fuzzy search - vim plugin
...
let g:markdown_composer_custom_css = ['https://cdn.jsdelivr.net/gh/cyrinux/github-markdown-css@gh-pages/github-markdown.css']
