...
map global user -docstring 'clip-paste (before)'  p      'o<esc>!wl-paste -t text/plain<ret><a-d>'
map global user -docstring 'clip-paste (after)'   P      'O<esc><a-!>wl-paste<ret><a-d>'
map global user -docstring 'clip-replace'         R      '|wl-paste<ret>'
...
map global user -docstring 'dmenu-buffers'         b      ': dmenu-buffers<ret>'
map global user -docstring 'dmenu-files'           f      ': dmenu-files<ret>'
map global user -docstring 'dmenu-files-in-folder' F      ': dmenu-files-in-folder<ret>'
