...
alias grbum='git rebase -i upstream/main || git rebase -i upstream/master'
alias gr='guit reset'
alias gr!='gr --hard'
alias grh='gr HEAD'
alias grh!='gr! HEAD'
...
alias gst='git --work-tree=$(pwd) stash'
alias gg='git number'
...
alias grelease='gh release create --generate-notes --draft --latest'
