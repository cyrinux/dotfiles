...
if is_chroot; then
    ...
    # systemctl_enable_start "git-annex.service"
    ...
    # systemctl_enable_start "gpg-agent.socket"
    # systemctl_enable_start "gpg-agent-ssh.socket"
    # systemctl_enable_start "gpg-agent-browser.socket"
    # systemctl_enable_start "gpg-agent-extra.socket"
    # systemctl_enable_start "dirmngr.socket"
