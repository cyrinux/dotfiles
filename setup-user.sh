...
link ".config/systemd/user/pomodoro.service"
...
link ".config/systemd/user/pulseeffects.service"
link ".config/tig"
link ".config/tmux"
...
if is_chroot; then
    ...
    systemctl_enable_start "udiskie.service"
    systemctl_enable_start "pulseaudio.service"
    systemctl_enable_start "pulseeffects.service"
    systemctl_enable_start "nm-applet.service"
    systemctl_enable_start "waybar.service"
    systemctl_enable_start "waybar-updates.timer"
    systemctl_enable_start "pomodoro.service"
