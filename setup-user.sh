...
link ".config/systemd/user/firejail-handler-http-ctl.service"
...
if is_chroot; then
    ...
    systemctl_enable_start "gnome-shell-screenshot-dbus-emulator@eDP-1.service"
    ...
    systemctl_enable_start "firejail-handler-http-ctl.service"
